...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # show the Success vs. Failed counts for the
                                # site
                                ...
                                # correlation between payload and launch
                                # success
                                html.Div(dcc.Graph(
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(class_counts,
                     values='count',
                     names='class',
                     title=f'{entered_site} Success and Failure Counts')
    return fig
...
def get_scatter_plot(enter_site, payload):
